// Premium email HTML šabloni za 0202skin — koriste {placeholder} sintaksu
// koju razrešava supabase/functions/_shared/email-template.ts (applyTemplate).
// Ovi stringovi se snimaju u bazu kroz admin Email podešavanja.
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:${BRAND_CREAM};border:1px solid ${BRAND_LINE};">
                <tr>
                  <td style="padding:22px 26px;">
                    ...
                    ${isAdmin ? `<div style="font-family:${MONO};font-size:11px;color:${BRAND_ACCENT};letter-spacing:0.05em;margin-top:8px;">{customerEmail}</div>` : ""}
                  </td>
                </tr>
              </table>
            </td>
