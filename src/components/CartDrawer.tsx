      ...
      {isCartOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 bg-warm-dark/40 backdrop-blur-sm z-50"
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full max-w-md bg-background z-50 flex flex-col shadow-2xl"
          >
            {/* Header */}
